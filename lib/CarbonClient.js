...
// XXX: this is a hack and it should be removed when https://github.com/goodeggs/fibrous/issues/31
//      gets cleared up
if (!(Function.prototype.hasOwnProperty('sync') && 
      Function.prototype.sync.hasOwnProperty('that'))) {
